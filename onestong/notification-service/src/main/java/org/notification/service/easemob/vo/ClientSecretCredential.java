package org.notification.service.easemob.vo;
...
public class ClientSecretCredential extends Credential {
	...
	public ClientSecretCredential(String clientID, String clientSecret, String role,String appkey,JerseyWebTarget tokenAppTarget ) {
		super(clientID, clientSecret);

		if (role.equals(Roles.USER_ROLE_APPADMIN)) {
			CLIENT_TOKEN_TARGET = tokenAppTarget
