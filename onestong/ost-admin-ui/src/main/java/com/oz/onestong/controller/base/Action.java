package com.oz.onestong.controller.base;
...
public class Action {
	...
	public String cms_domain;
	public String attach_path;

	protected Log logger = LogFactory.getLog(this.getClass());

	public static void renderHTML(HttpServletResponse res, String s) {
		render(res, s, "text/html;charset=utf-8");
	}

	public static void renderJson(HttpServletResponse res, String s) {
		render(res, s, "text/Json;charset=utf-8");
	}
	...
	private static void render(HttpServletResponse res, String s, String contextType) {
		try {
			...
			res.getOutputStream().write(new String(s).getBytes());
