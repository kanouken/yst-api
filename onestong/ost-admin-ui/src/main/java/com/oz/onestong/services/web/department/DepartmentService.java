package com.oz.onestong.services.web.department;
...
import com.oz.onestong.model.department.DepartmentExample.Criteria;
...
public class DepartmentService {
	...
	public List<Department> findAllTopDepartments(Integer domainId) {
		...
		de.createCriteria().andValidEqualTo(Constants.DATA_VALID).andIsLeafEqualTo(Constants.IS_NOT_LEAF).andDomainIdEqualTo(domainId);
