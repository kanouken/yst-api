...
public class ApprovalReportService {
	...
	public ByteArrayOutputStream approvalExport(String departmentName, String signedTime, String signoutTime,
		...
		List<ApprovalReportDto> _listBusinessTrip = attenceReportDao.selectbusinessTripByList(departmentName, start, end,
				rowBounds);
		...
		List<ApprovalReportDto> _listLeave = attenceReportDao.selectLeaveByList(departmentName, start, end, rowBounds);
